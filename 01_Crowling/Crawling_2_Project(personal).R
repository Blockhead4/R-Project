...
ifr_base_url <- "https://movie.naver.com/movie/bi/mi/pointWriteFormList.nhn?code=101966&type=after&onlyActualPointYn=N&order=newest&page="
pages <- c(1:37)
...
for(i in 1:max(pages)) {
  ...
  points2 <- rbind.data.frame(points2, result)
}
head(points2)

write.xlsx(points2, "data/points2.xlsx")
